...
- last_archived	last_archived_wal	Name of the last WAL file successfully archived, empty if nothing has been archived yet
- archived_age	last_archived_time	Time elapsed since the last successful archiving, empty if nothing has been archived yet
- failed	failed_count		Total number of failed attempts to archive a WAL file
- last_failed	last_failed_wal		Name of the WAL file of the last failed archiving attempt, empty if there were no failures
- failed_age	last_failed_time	Time elapsed since the last failed archiving attempt, empty if there were no failures
- stats_age	stats_reset		Age of collected statistics in the moment when stats are taken
