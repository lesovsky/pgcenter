...
> **ПОПРАВКИ ПОСЛЕ УТВЕРЖДЁННЫХ РЕШЕНИЙ USER-SPEC (2026-08-03).** Три места ниже описывают формы,
> которые спека прямо запрещает. Техническое задание пишется по спеке, а не по ним:
>
...
>    первого тика (`collecting...`) и содержит ветку чтения файла лога; при перерисовке из
>    хранилища обе должны быть пропущены.
