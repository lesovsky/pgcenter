...
- [ ] **Происхождение пакетов, а не их версии:** все пакеты PostgreSQL, кроме `postgresql-19` /
      `postgresql-plperl-19`, разрешаются из стабильного канала — `apt-cache policy postgresql-14..18
...
- Пин: в контейнере `apt-cache policy` показывает бета-источник с приоритетом 100, стабильный
